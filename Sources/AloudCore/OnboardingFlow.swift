...
/// Whether the system has said yes to something Aloud asked for.
///
...
public struct OnboardingFlow: Equatable, Sendable {
    ...
    ///
    /// Aloud is a dictation app and there is no version of it that works without hearing
