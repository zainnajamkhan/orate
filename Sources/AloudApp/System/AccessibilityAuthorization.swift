...
/// The optional one.
///
/// Accessibility is what lets Aloud put the text straight into whatever window the user was
...
public enum AccessibilityAuthorization {
    ...
    /// is in System Settings looking away from Aloud, and the cost of noticing a second
