...
///
/// Aloud does not sit and listen, and this is where that promise is either kept or broken.
/// The engine is built and torn down around each dictation rather than left running with a
/// gate on it, so the orange recording dot in the menu bar is on exactly when Aloud is
...
enum DictationError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .unsupportedAudioFormat:
            "This microphone produces audio Aloud cannot read."
