...
public final class DictationEngine: ObservableObject {
    ...
    ///
    /// The shortcut step watches this to prove the key actually reached Aloud. Nothing else
    /// can prove it: another app can swallow a shortcut before Aloud sees it, and the
