...
struct MicrophoneStep: View {
    ...
    var body: some View {
        StepScaffold(
            headline: granted ? "Aloud can hear you" : "Aloud needs your microphone",
            lead: granted
            ...
            VStack(alignment: .leading, spacing: Space.large) {
                ...
                VStack(alignment: .leading, spacing: Space.large) {
                    Point(
                        ...
                        detail: "Aloud does not sit and listen. The microphone opens when you press the shortcut and closes the moment you let go."
                    )
                    .entrance(3)
                    Point(
                        symbol: "trash",
    ...
    private var statusText: String {
        ...
        case .granted: "Granted. Aloud can hear you."
