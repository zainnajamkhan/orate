...
struct PastingStep: View {
    ...
    var body: some View {
        StepScaffold(
            ...
            lead: granted
                ...
                : "Aloud can put the text straight where your cursor is. Without this it copies to the clipboard instead and you paste it yourself."
        ) {
            VStack(alignment: .leading, spacing: Space.large) {
                ...
                Text("Aloud only ever writes. It does not read the contents of your screen or your other windows.")
                    .font(Type.detail)
    ...
    private var statusText: String {
        granted ? "Granted. Aloud can type for you." : "Not granted. Aloud will use the clipboard."
    }
}
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: Space.small) {
            Image(systemName: symbol)
                .font(Type.title)
                .foregroundStyle(isPreferred ? Color.aloud : Color.secondary)
        ...
        .background(
            RoundedRectangle(cornerRadius: Radius.large, style: .continuous)
                .fill(isPreferred ? Color.aloud.opacity(0.08) : Color.aloudWell)
        )
        .overlay(
            RoundedRectangle(cornerRadius: Radius.large, style: .continuous)
                .strokeBorder(
                    isPreferred ? Color.aloud.opacity(0.28) : Color.clear,
                    lineWidth: 1
                )
        )
