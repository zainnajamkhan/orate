...
public enum Diagnostics {
    ...
    private static let logger = Logger(subsystem: "com.zainnajamkhan.orate", category: "app")
    ...
    private static let fileURL: URL? = {
        ...
        let directory = logs.appendingPathComponent("Logs/Orate", isDirectory: true)
        try? FileManager.default.createDirectory(at: directory, withIntermediateDirectories: true)
        return directory.appendingPathComponent("orate.log")
    }()
