    ...
    private var captionText: String {
        ...
        case .microphone:
            model.flow.microphone == .granted
                ...
                : "macOS asks once. Orate cannot ask on its own behalf."
...
private struct WelcomeHero: View {
    var body: some View {
        ZStack {
            ...
            OrateMark(size: 104, animated: true)
        }
        .frame(height: 240)
    }
}
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: Space.small) {
                ...
                HStack(spacing: 3) {
                    Capsule()
                        .fill(granted ? Color.orate.opacity(0.95) : .white.opacity(0.16))
...
private struct ReadyHero: View {
    ...
    var body: some View {
        VStack(spacing: Space.section) {
            // The menu bar, mocked, with Orate's icon lit. This is the answer to the one
