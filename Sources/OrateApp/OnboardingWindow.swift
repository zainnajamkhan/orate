...
/// the `openWindow` action. Orate is a menu bar app with no Dock icon, so the scene that
...
public enum OnboardingWindow {
    ...
    public static let completedKey = "orate.onboardingCompleted"
    ...
    public static func present(
        ...
        created.title = "Welcome to Orate"
