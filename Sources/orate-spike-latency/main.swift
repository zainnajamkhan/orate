...
/// S0. The only number that decides whether Orate gets built.
///
...
guard arguments.count > 1 else {
    print("""
    usage: orate-spike-latency <audio file> [more files...]
...
print("Orate S0: latency from the end of speech to the finished text")
